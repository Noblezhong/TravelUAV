...
class CommonArguments:
    ...
    scheduler_drift_weight: float = field(default=1.0, metadata={"help": "reward weight for scheduler state drift"})
    scheduler_request_weight: float = field(default=0.05, metadata={"help": "reward penalty for edge VLM request"})
    scheduler_illegal_weight: float = field(default=2.0, metadata={"help": "reward penalty for illegal scheduler action"})
    scheduler_success_reward: float = field(default=20.0, metadata={"help": "terminal reward for navigation success"})
    ...
    scheduler_idle_wait_ms: float = field(default=100.0, metadata={"help": "small hover duration for illegal idle scheduler actions"})
