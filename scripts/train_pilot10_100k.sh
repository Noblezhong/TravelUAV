#!/bin/bash
# pilot10 (0903→0902) todo#4: 续训到 100k，观察长训动作分布是否坍缩。
#   续训自 20k checkpoint (drl_train_pilot10_20k_0901-1507)，resume 从 20000 继续到 100000。
...
CUDA_VISIBLE_DEVICES=0 python -u $root_dir/src/vlnce_src/drl_scheduler_train.py \
    --run_type eval \
    --name TravelLLMPCDRLSchedulerTrainPilot10 \
    --gpu_id 0 \
    ...
    --eval_save_path $REPO_ROOT/drl_train_pilot10_20k_0901-1507 \
