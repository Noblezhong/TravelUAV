...
CUDA_VISIBLE_DEVICES=0 python -u $root_dir/src/vlnce_src/continue_eval_buffer_trim.py \
    --run_type eval \
    --name TravelLLMPCBufferTrim${name_suffix} \
    --gpu_id 0 \
    ...
    --eval_save_path /HDD1/code/TravelUAV/eval_pro_con_trim${com_suffix}_w${chunk_waypoints} \
