...
CUDA_VISIBLE_DEVICES=0 python -u $root_dir/src/vlnce_src/drl_scheduler_train.py \
    ...
    --scheduler_time_weight 0.2 \
    --scheduler_drift_weight 2.0 \
    --scheduler_time_drift_norm_ms 5000 \
    --scheduler_time_drift_weight 2.0 \
    --scheduler_request_weight 0.2 \
    ...
    --eval_save_path /HDD1/code/TravelUAV/drl_train_$run_ts \
    ...
    --eval_json_path /HDD1/code/TravelUAV/drl_scheduler_seen_curriculum.json \
