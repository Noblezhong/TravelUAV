...
dataset_path="/mnt/traveluav_data/TravelUAV_data"
chunk_waypoints=5
...
eval_json_path="$dataset_path/data/uav_dataset/seen_valset.json"
map_spawn_area_json_path="$dataset_path/data/meta/map_spawnarea_info.json"
